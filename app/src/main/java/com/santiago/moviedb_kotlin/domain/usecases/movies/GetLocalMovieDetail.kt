...
class GetLocalMovieDetail @Inject constructor(private val repository: MoviesRepository) {
    suspend fun execute(movieId: Int): Movie = DataMapper.Movies.fromLocal(repository.getLocalMovieDetail(movieId))
}